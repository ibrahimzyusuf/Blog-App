...
return (
    <section className="post-details">
        <div className="post-details-image-wrapper">
            <img src={file?URL.createObjectURL(file):post?.image.url} alt="post" className="post-details-image" loading="lazy" />
        ...
        <div className="post-details-user-info">
            <img src={post?.user?.profilePhoto?.url} alt="profile" className="post-details-user-image" loading="lazy" />
